...
public:
	...
	void WriteToFileParticle(ParticleClassVector pcv, double volumen, int name, double wasserDampfMasse, double glycerinDampfMasse, double stickStoffDampfMasse);
